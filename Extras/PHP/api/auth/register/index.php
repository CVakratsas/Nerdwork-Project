...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "INSERT INTO users (id, username, password, validationid, email, displayName, orientation) VALUES (?, ?, ?, ?, ?, ?, ?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssssi", $param_id, $param_username, $param_password, $param_validationid, $param_email, $param_displayName, $param_orientation);
            ...
            $param_password = password_hash($data['password'], PASSWORD_DEFAULT); // Creates a password hash
